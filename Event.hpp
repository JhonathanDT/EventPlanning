...
class Event{
    public:
         ...
         */
        std::vector<std::string> getGuests() const; //wait
        /**
    ...
    private:    
        ...
        /**
         * @brief Convert the guest_ vector into a string that fits the format of the project
         * 
         * @return std::string String representation of the guests numbers from first to last
         */
        std::string guestsToString()const;
};
#endif //EVENTS_HPP_